        ...
        <div className="wrap">
          ...
          <div className="content">
            <span className="char state-1">
              <span data-label="A" style={{ '--i': 1 } as React.CSSProperties}>
                A
              </span>
              <span data-label="d" style={{ '--i': 2 } as React.CSSProperties}>
                d
              </span>
              <span data-label="d" style={{ '--i': 3 } as React.CSSProperties}>
                d
              </span>
              <span data-label="" style={{ '--i': 3 } as React.CSSProperties}>
                
              </span>
              <span data-label="T" style={{ '--i': 5 } as React.CSSProperties}>
                T
              </span>
              <span data-label="a" style={{ '--i': 6 } as React.CSSProperties}>
                a
              </span>
              <span data-label="s" style={{ '--i': 7 } as React.CSSProperties}>
                s
              </span>
              <span data-label="k" style={{ '--i': 8 } as React.CSSProperties}>
                k
              </span>
            ...
            <span className="char state-2">
              ...
              <span data-label="" style={{ '--i': 4 } as React.CSSProperties}>
